...
namespace AllCashUFormsApp.Reports {
    ...
    public class RPT_DSR_KPI : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "AllCashUFormsApp.Reports.RPT-DSR-KPI.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_DSR_KPI : Component, ICachedReport {
        
        public CachedRPT_DSR_KPI() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_DSR_KPI rpt = new RPT_DSR_KPI();
            rpt.Site = this.Site;
            return rpt;
        }
