...
namespace AllCashUFormsApp.Model
{
    ...
    public partial class tbl_ApSupplierType
    {
        public int APSupplierTypeID { get; set; }
        public string ApSupplierTypeCode { get; set; }
        public string ApSupplierTypeName { get; set; }
