...
namespace AllCashUFormsApp.Model
{
    ...
    public partial class tbl_PromotionVan
    {
        public int PromotionVanID { get; set; }
        public string PromotionVanCode { get; set; }
        public string PromotionVanName { get; set; }
        public string Description { get; set; }
        public Nullable<System.DateTime> StartDate { get; set; }
        public Nullable<System.DateTime> ExpiryDate { get; set; }
        public string PromotionVanType { get; set; }
