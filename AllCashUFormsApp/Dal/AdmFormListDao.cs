...
namespace AllCashUFormsApp
{
    public static class AdmFormListDao
    {
        ...
        {
            string msg = "start AdmFormListDao=>Insert";
            msg.WriteLog(null);
        ...
        {
            string msg = "start AdmFormListDao=>Update";
            msg.WriteLog(null);
        ...
        {
            string msg = "start AdmFormListDao=>Delete";
            msg.WriteLog(null);
