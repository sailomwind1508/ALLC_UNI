<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="kRowByName" match="Rep_Sum_Shelf_Daily_XSLT" use="WHID"/>
...
grouping-separator="'" digit="#" zero-digit="0" decimal-separator="."/>
				...
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="6">
							<xsl:value-of select="Rep_Sum_Shelf_Daily_XSLT/CompanyName" />
						</TD>
					</TR>
					<TR>
						<TD class="stdPageHdr" Colspan="6">
					...
					<TR>
						...
						<TD class="SearchResultItem" Colspan="3" style="text-align: center;">
							<xsl:value-of select="Rep_Sum_Shelf_Daily_XSLT/BranchName" />
						</TD>
						...
						<TD class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Sum_Shelf_Daily_XSLT/YearBE" />
						</TD>
					</TR>
					<TR>
						<TD Colspan="6"></TD>
                 ...
                 generate-id(key('kRowByName', WHID))]">
						...
						<!--<tr>
							...
							<td Class="SearchResultItem" align="Right">
								<xsl:value-of select="format-number(Rep_Sum_Shelf_Daily_XSLT/TotalCountCus,'#,##0')" />
							</td>
							...
							<td class="SearchResultItem">
								<xsl:value-of select="format-number(sum(Rep_Sum_Shelf_Daily_XSLT/CouShef),'#,##0')"/>
							</td>
						</tr>-->
					</tbody>
				</Worksheet>
	...
	<xsl:template match="Rep_Sum_Shelf_Daily_XSLT">
		<tr>
