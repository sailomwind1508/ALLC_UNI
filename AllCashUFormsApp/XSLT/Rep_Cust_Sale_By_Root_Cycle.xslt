<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="kRows" match="Rep_Cust_Sale_By_Root_XSLT_Cycle" use="WHID"/>
...
grouping-separator="'" digit="#" zero-digit="0" decimal-separator="."/>
	...
	<xsl:template match="NewDataSet">
		<html>
			...
			<table>
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="17">
							<xsl:value-of select="Rep_Cust_Sale_By_Root_XSLT_Cycle/CompanyName" />
						</TD>
					</TR>
					<TR>
						<TD class="stdPageHdr" Colspan="17">
					...
					<TR>
						...
						<TD colspan="3" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Cust_Sale_By_Root_XSLT_Cycle/BranchName" />
						</TD>
						<TD class="ResultItem" style="font-weight: bold;text-align: center;" align="Center">
							Date :
						</TD>
						<TD colspan="3" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Cust_Sale_By_Root_XSLT_Cycle/HDate" />
						</TD>
					</TR>
					<TR>
						<TD Colspan="5"></TD>
                ...
                "//Rep_Cust_Sale_By_Root_XSLT_Cycle
                [generate-id() = 
	...
	<xsl:template match="Rep_Cust_Sale_By_Root_XSLT_Cycle">
		<tr>
