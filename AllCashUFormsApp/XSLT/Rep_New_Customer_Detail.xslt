    ...
    <![CDATA[<?mso-application progid="Excel.Sheet"?> ]]>    
		...
		<ss:Workbook>
			<ss:Worksheet ss:Name="รายการลูกค้าใหม่">
				<ss:Table>
					<xsl:apply-templates select="Rep_New_Customer_Detail_XSLT"/>
				</ss:Table>
			</ss:Worksheet>
		</ss:Workbook>
	</xsl:template>
				...
				<table>
					<tr>
						<td Colspan="5" style="font-weight: bold;font-size: 11pt;">
							<xsl:value-of select="NewDataSet/Rep_New_Customer_Detail_XSLT/CompanyName"/>
						</td>
					</tr>
					<tr>
						<td Colspan="5" style="font-weight: bold;font-size: 11pt;">
					...
					<tr>
						...
						<td Colspan="3" style="font-weight: bold;font-size: 11pt;">
							<xsl:value-of select="NewDataSet/Rep_New_Customer_Detail_XSLT/BranchName"/>
							(<xsl:value-of select="NewDataSet/Rep_New_Customer_Detail_XSLT/BranchID"/>)
						</td>
						<td style="font-weight: bold;font-size: 11pt;text-align:right;">ปี : </td>
						<td>
							<xsl:value-of select="NewDataSet/Rep_New_Customer_Detail_XSLT/Y"/>
						</td>
					</tr>
					<tr></tr>
					...
					<xsl:for-each select="NewDataSet/Rep_New_Customer_Detail_XSLT">
						<tr>
							<TD class="TDetail">
