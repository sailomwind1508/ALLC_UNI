<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="Rep_BillByDate_ExcVat_XSLT_Cycle">
    ...
    <![CDATA[<?mso-application progid="Excel.Sheet"?> ]]>    
		...
		<ss:Workbook>
			<ss:Worksheet ss:Name="รายงานยอดขายไม่รวมVat(บาท)">
				<ss:Table>
					<xsl:apply-templates select="Rep_BillByDate_ExcVat_XSLT_Cycle"/>
				</ss:Table>
			</ss:Worksheet>
		</ss:Workbook>
	</xsl:template>
				...
				<TABLE>
					<TR>
						<TD colspan="3" class="ReportHead">
							<xsl:value-of select="NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/CompanyName"/>
						</TD>
					</TR>
					<TR>
						<TD colspan="3" class="ReportHead">
					...
					<TR>
						...
						<TD class="header" colspan="2">
							<xsl:value-of select="NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/BranchName"/>
						</TD>
						<TD class="gridHeader" colspan="1">Year :</TD>
						<TD class="header" colspan="2">
							<xsl:value-of select="NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Year"/>
						</TD>
						<TD class="gridHeader" colspan="1">Month :</TD>
						<TD class="header" colspan="2">
							<xsl:value-of select="NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Month"/>
						</TD>
					</TR>
					<TR></TR>
					<TR></TR>
					...
					<xsl:for-each select="NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle">
					...
					<TR Class="GroupFooter">
						...
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day1),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day2),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day3),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day4),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day5),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day6),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day7),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day8),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day9),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day10),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day11),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day12),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day13),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day14),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day15),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day16),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day17),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day18),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day19),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day20),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day21),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day22),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day23),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day24),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day25),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day26),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day27),"#,##0.00")'/>
						</TD>
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/Day28),"#,##0.00")'/>
						</TD>
		
						<TD Class="subTotals" align="right">
							<xsl:value-of select='format-number(sum(/NewDataSet/Rep_BillByDate_ExcVat_XSLT_Cycle/AllAmount),"#,##0.00")'/>
						</TD>
					</TR >
				</TABLE>
			</BODY>
