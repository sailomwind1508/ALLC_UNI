<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="kRows" match="Rep_Customer_By_Cycle_XSLT_Cycle" use="WHID"/>
	...
	<xsl:template match="NewDataSet">
		<html>
			...
			<table>
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="5">
							<xsl:value-of select="Rep_Customer_By_Cycle_XSLT_Cycle/CompanyName" />
						</TD>
					</TR>
					<TR>
					...
					<TR>
						...
						<TD class="SearchResultItem" Colspan="3" style="text-align: center;">
							<xsl:value-of select="Rep_Customer_By_Cycle_XSLT_Cycle/BranchName" />
						</TD>
						...
						<TD class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Customer_By_Cycle_XSLT_Cycle/Year" />
						</TD>
					</TR>
					<TR>
						<TD Colspan="4"></TD>
                ...
                "//Rep_Customer_By_Cycle_XSLT_Cycle
                [generate-id() = 
	...
	<xsl:template match="Rep_Customer_By_Cycle_XSLT_Cycle">
		<tr>
