				...
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="7">
							<xsl:value-of select="Rep_Detail_Sales_By_Cust_XSLT/CompanyName" />
						</TD>
					</TR>
					<TR>
						<TD class="stdPageHdr" Colspan="7">
							รายงานรายละเอียดขายสินค้า (แยกตามลูกค้า)
						</TD>
					</TR>
					<TR>
						<TD Colspan="7"></TD>
					...
					<TR>
						...
						<TD class="SearchResultItem" Colspan="3" style="text-align: center;">
							<xsl:value-of select="Rep_Detail_Sales_By_Cust_XSLT/BranchName" />
						</TD>
						...
						<TD colspan="2" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Detail_Sales_By_Cust_XSLT/HDate" />
						</TD>
						<TD class="SearchResultItem" style="font-weight: bold;text-align: center;" align="Center">
							Van :
						</TD>
						<TD class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Detail_Sales_By_Cust_XSLT/VanName" />
						</TD>
					</TR>
					<TR>
						<TD Colspan="7"></TD>
