<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="kRowByName" match="Rep_ActualSale_By_Customer_Bath_XSLT" use="DocKey"/>
...
grouping-separator="'" digit="#" zero-digit="0" decimal-separator="."/>
	...
	<xsl:template match="NewDataSet">
		<html>
			...
			<table>
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="7">
							<xsl:value-of select="Rep_ActualSale_By_Customer_Bath_XSLT/CompanyName" />
						</TD>
					</TR>
					<TR>
						<TD class="stdPageHdr" Colspan="7">
					...
					<TR>
						...
						<TD colspan="1" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_ActualSale_By_Customer_Bath_XSLT/Year" />
						</TD>
						...
						<TD class="SearchResultItem" Colspan="4" style="text-align: center;">
							<xsl:value-of select="Rep_ActualSale_By_Customer_Bath_XSLT/BranchName" />
						</TD>
                ...
                "//Rep_ActualSale_By_Customer_Bath_XSLT
                [generate-id() = 
	...
	<xsl:template match="Rep_ActualSale_By_Customer_Bath_XSLT">
		<tr>
