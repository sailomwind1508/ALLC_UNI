<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="kRowByName" match="Rep_ProductHero_ByDate" use="WHID"/>
...
grouping-separator="'" digit="#" zero-digit="0" decimal-separator="."/>
				...
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="4">
							<xsl:value-of select="Rep_ProductHero_ByDate/CompanyName" />
						</TD>
					</TR>
					...
					<TR>
						...
						<TD class="SearchResultItem" Colspan="3" style="text-align: center;">
							<xsl:value-of select="Rep_ProductHero_ByDate/Depot"/>
						</TD>
					</TR>
					...
					<TR>
						...
						<TD class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_ProductHero_ByDate/StartYear" />
						</TD>
						...
						<TD class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_ProductHero_ByDate/StartCycle" />
						</TD>
						...
						<TD class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_ProductHero_ByDate/EndYear" />
						</TD>
						...
						<TD class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_ProductHero_ByDate/EndCycle" />
						</TD>
					</TR>
					...
					<tbody>
						<xsl:apply-templates select= "//Rep_ProductHero_ByDate [generate-id() 
	...
	<xsl:template match="Rep_ProductHero_ByDate">
		<tr>
