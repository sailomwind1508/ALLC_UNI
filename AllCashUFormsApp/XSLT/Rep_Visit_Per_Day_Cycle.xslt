<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="kRows" match="Rep_Visit_Per_Day_XSLT_Cycle" use="WHID"/>
...
grouping-separator="'" digit="#" zero-digit="0" decimal-separator="."/>
				...
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="11">
							<xsl:value-of select="Rep_Visit_Per_Day_XSLT_Cycle/CompanyName" />
						</TD>
					</TR>
					<TR>
						<TD class="stdPageHdr" Colspan="11">
					...
					<TR>
						...
						<TD class="SearchResultItem" Colspan="3" style="text-align: center;">
							<xsl:value-of select="Rep_Visit_Per_Day_XSLT_Cycle/BranchName" />
						</TD>
						...
						<TD colspan="3" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Visit_Per_Day_XSLT_Cycle/HDate" />
						</TD>
						<TD class="SearchResultItem" style="font-weight: bold;text-align: center;" align="Center">
							Today :
						</TD>
						<TD colspan="2" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_Visit_Per_Day_XSLT_Cycle/CurentDate" />
						</TD>
					</TR>
					<TR>
						<TD Colspan="11"></TD>
	...
	<xsl:template match="Rep_Visit_Per_Day_XSLT_Cycle">
		<tr>
			<td class="ResultItem">
