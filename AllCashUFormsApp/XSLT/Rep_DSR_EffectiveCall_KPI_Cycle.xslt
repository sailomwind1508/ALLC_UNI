<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="kRows" match="Rep_DSR_EffectiveCall_KPI_XSLT_Cycle" use="EmpName"/>
...
grouping-separator="'" digit="#" zero-digit="0" decimal-separator="."/>
	...
	<xsl:template match="NewDataSet">
		<html>
			...
			<table>
				<Worksheet Name="รายวัน">
					<TR>
						<TD class="stdPageHdr" colspan="13">
							<xsl:value-of select="Rep_DSR_EffectiveCall_KPI_XSLT_Cycle/CompanyName" />
						</TD>
					</TR>
					<TR>
						<TD class="stdPageHdr" Colspan="13">
					...
					<TR>
						...
						<TD class="SearchResultItem" Colspan="4" style="text-align: center;">
							<xsl:value-of select="Rep_DSR_EffectiveCall_KPI_XSLT_Cycle/BranchName" />
						</TD>
						...
						<TD colspan="2" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_DSR_EffectiveCall_KPI_XSLT_Cycle/Round" />
						</TD>
						<TD colspan="2" class="SearchResultItem" style="font-weight: bold;text-align: center;" align="Center">
							วันที่ :
						</TD>
						<TD colspan="4" class="SearchResultItem" style="text-align: center;">
							<xsl:value-of select="Rep_DSR_EffectiveCall_KPI_XSLT_Cycle/HDate" />
						</TD>
					</TR>
					<TR>
						<TD Colspan="13"></TD>
                ...
                "//Rep_DSR_EffectiveCall_KPI_XSLT_Cycle
                [generate-id() = 
	...
	<xsl:template match="Rep_DSR_EffectiveCall_KPI_XSLT_Cycle">
		<tr>
