...
{
    public class RJ : BaseControl, IObject
    {
        private Func<tbl_PRMaster, bool> _rjDocTypePredicate = null;
        public virtual Func<tbl_PRMaster, bool> rjDocTypePredicate
        {
            get { return _rjDocTypePredicate; }
            set
            {
                _rjDocTypePredicate = value;
            }
        }

        public RJ() : base("RJ")
        {
            _rjDocTypePredicate = (x => x.DocTypeCode.Trim() == "RJ");
        }
        ...
        public virtual DataTable GetDataTable(bool isPopup = true)
        {
            try
            {
                ...
                //tbl_PRMaster = (new tbl_PRMaster()).Select(rjDocTypePredicate);
                ...
                string sql = "proc_RJ_GetDataTable";
