...
{
    public partial class frmCrystalReportEx : Form
    {
        ...
        public frmCrystalReportEx()
        {
            InitializeComponent();
        }

        private void frmCrystalReportEx_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void frmCrystalReportEx_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
