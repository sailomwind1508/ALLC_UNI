...
namespace AllCashUFormsApp.View.Page
{
    public partial class frmTabletSalesPre : Form
    {
        ...
        Func<tbl_BranchWarehouse, bool> whFunc = (x => x.WHType == 2); // x.WHID.Contains("V"));
        ...
        private void PreparePOMaster(bool editFlag = false)
        {
            ...
            if (checkEditMode)
                ...
                po.DocNo = bu.GenDocNewNoPreEx(docTypeCode, txtWHCode.Text, dtpDocDate.Value);
        ...
        private void Save()
        {
            try
            {
                ...
                if (checkEditMode)
                {
                    ...
                    if (!string.IsNullOrEmpty(cboRemark.Text))
                    {
                        bu.tbl_POMaster.Remark = cboRemark.Text;
                    }
                ...
                else
                {
                    ...
                    docno = bu.GenDocNewNoPreEx(docTypeCode, txtWHCode.Text, dtpDocDate.Value);
                    editFlag = false;
        ...
        private void btnSearchDoc_Click(object sender, EventArgs e)
        {
            ...
            this.OpenIVDocPopup("ใบกำกับสินค้า/กำกับภาษี", "IVPre", isShowAll);
        }
