...
{
    public partial class frmPayCredit : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else //Update
                {
                    ...
                    {
                        if (string.IsNullOrEmpty(payDetailsOld[i].AllMoneyCredit.ToString()))
                        {
                            payDetailsOld[i].AllMoneyCredit = 0;
                        }
        ...
        private void SetReadOnlyGridView(bool flag)
        {
            ...
            gridPayment.Columns["colAllMoneyCredit"].ReadOnly = flag;
        ...
        private void BindBankNote()
        {
            ...
            if (dtBankNote.Rows.Count > 0)
            {
                ...
                dt.Columns.Add("AllMoneyCredit", typeof(decimal));
                ...
                foreach (DataRow r in dtBankNote.Rows)
                {
                    ...
                    , Convert.ToDecimal(r["AllMoneyCredit"]).ToDecimalN2()
        ...
        private void CalculateRow(DataGridView grd, int rowIndex)
        {
            try
            {
                ...
                var cellAllMoneyCredit = grd.Rows[rowIndex].Cells["colAllMoneyCredit"];
                ...
                AllMoneyCredit = Convert.ToDecimal(cellAllMoneyCredit.EditedFormattedValue);

                decimal totalsends = Send + Transfer + Deposit + AllMoneyCredit;
        ...
        private void PrePareSave_PayDetail(List<tbl_PayDetail> payDetailList, string DocNo)
        {
            ...
            for (int i = 0; i < gridPayment.Rows.Count; i++)
            {
                ...
                paydetail.AllMoneyCredit = Convert.ToDecimal(gridPayment.Rows[i].Cells["colAllMoneyCredit"].Value);
