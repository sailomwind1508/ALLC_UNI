...
namespace AllCashUFormsApp.View.Page
{
    public partial class frmVE : Form
    {
        ...
        private void BindIVMaster(tbl_IVMaster obj)
        {
            ...
            if (obj.DocRef.Contains("M"))
            {
                txnBeforeVat.Text = ((obj.TotalDue * 100) / 107).ToStringN2();//(obj.IncVat.Value - obj.VatAmt.Value).ToStringN2();
            }
            else
            ...
            try
            {
                ...
                if (checkEditMode)
                {
                    ...
                    if (ddlDocStatus.SelectedValue.ToString() == "5")
                    {
                        ...
                        if (bu.tbl_IVMaster.DocNo.Length < 8)
                        {
        ...
        private void frmVE_FormClosed(object sender, FormClosedEventArgs e)
        {
